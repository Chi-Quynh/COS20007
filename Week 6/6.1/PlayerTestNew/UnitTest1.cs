...
namespace PlayerTest
{
    public class TestPlayer
    {
        ...
        [Test]
        public void PlayerItemNotlocated() {
            
            Assert.IsFalse(_player.Locate("nope") == _player); }

        [Test]
        public void PlayerFullDescription() {
            Item TestItem = new Item(new string[] { "spoon", "gold" }, "golden spoon", "a goldspoon");
            _player.Inventory.Put(TestItem);
            Assert.AreEqual(_player.FullDescription, "You are id1, you are carrying\ngolden spoon (spoon)") ; }
